...
function ProductCard({ product }: { product: Product }) {
  return (
    <article
      id={product.id}
      className="flex scroll-mt-24 flex-col rounded-2xl border border-white/10 bg-white/[0.03] p-7 transition-colors hover:border-white/20"
    >
      ...
      <p className="mt-4 text-[15px] font-medium text-ivory/90">{product.tagline}</p>
