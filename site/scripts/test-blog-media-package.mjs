...
assert.ok(prompt.includes("neutral grayscale only"));
assert.ok(prompt.includes("do not render these hues into the master"));
assert.ok(prompt.includes(imageStyle.fallback.condition));
