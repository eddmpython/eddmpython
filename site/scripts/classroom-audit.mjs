...
const EXPECT = {
  ...
  "expense-variables": ["영업팀", "관리팀"],
  "expense-numbers": ["120000 0.1", "True", "200000"],
  "expense-list": ["[50000, 120000, 80000]"],
  "expense-dict": ["dict_keys", "120000"],
  "expense-comparisons": ["False", "True"],
  "expense-loop": ["50000", "120000", "80000"],
  "expense-condition": ["50000 : 정상", "120000 : 확인필요", "100000 : 기준과 같음"],
  "expense-function": ["-첫 번째 검토:", "-두 번째 검토:", "120000 : 확인필요"],
  "expense-syntax-together": ["관리팀 120000 : 확인필요", "합계 250000", "확인 대상 1"],
  ...
  "merge-count": ["모두 7건", "합계 460,000원"],
  "check-preserve": ["건수 보존  7 = 6 + 1  PASS", "금액 보존  460,000 = 460,000  PASS"],
};
