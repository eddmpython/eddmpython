...
고칠 때는 전역 `$blog-writing`의 순서에 따라 세 명 이상이 따로 읽는다. 첫 독자는 도입만 읽고
독자와 문제와 결과가 바로 보이는지 확인한다. 구조 편집자는 주장과 근거와 다음 행동이 이어지는지
본다. 문체 편집자는 일상에서 잘 쓰지 않는 말, AI 관용구, 반복을 찾는다. 작성자는 세 의견을
반영한 뒤 같은 세 역할의 평가를 다시 받는다.
